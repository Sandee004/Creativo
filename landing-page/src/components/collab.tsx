...
const Collab = () => {
    return (
        ...
        <div className="bg-black w-[100%] flex flex-col sm:flex-row p-5 text-white justify-between">
            ...
            <footer class="bg-black text-white py-4 px-5 flex flex-wrap justify-around">
              <div class="w-full sm:w-1/3 mb-4 md:mb-0">
              ...
              <p class="font-bold text-[20px] mt-5">hello@creativo.com</p>
                <p class="font-bold text-[20px]">+1-800-123 4567</p>
              </div>
              <div class="grid grid-cols-2 sm:grid-cols-3 gap-20 row-gap-2 sm:w-1/3 text-sm mt-5">
                <div>
                  ...
                  <div>
                    <h3 class="font-bold mb-2">Discover</h3>
                    <ul class="list-none pl-0">
                      <li className="py-1">
